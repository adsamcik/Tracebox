...
| F0.2 | Pin toolchains and dependencies | F0.1 | Gradle, AGP, Kotlin, JDK, NDK, CMake, Rust, Crashpad revisions locked and verified | PASS | b0f7c22fb74fb661a65a0fd24c99d841944471ae | Crashpad reuse now rehashes the complete expected post-patch source tree; the targeted tamper test reconstructs the immutable source and restores the expected hash. See `evidence/phase0/review-fix-host-validation.json`. |
