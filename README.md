...
```kotlin
implementation("io.github.tracebox:tracebox:0.1.0-alpha.8")
implementation("io.github.tracebox:tracebox-native:0.1.0-alpha.8")
implementation("io.github.tracebox:tracebox-ui-compose:0.1.0-alpha.8")
```
