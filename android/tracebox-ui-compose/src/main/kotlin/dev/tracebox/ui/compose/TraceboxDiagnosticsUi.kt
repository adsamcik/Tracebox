...
data class TraceboxDiagnosticsUiStrings(
    ...
    val policyUpdated: String = "Runtime controls updated.",
    val policyRestrictedLocally: String =
        "Restrictions are durable locally; another process is still stopping.",
    val policyPartiallyApplied: String =
        "The policy is durable, but one runtime participant is degraded.",
    val policyFailed: String = "The policy was not changed.",
    val packageReviewCancelled: String = "Package review was cancelled.",
    val diagnosticsNotReady: String = "Diagnostics are not ready for packaging.",
    val packageApprovalMismatch: String = "The approval did not match the reviewed package.",
    val packageShareFailed: String = "The package could not be shared.",
    val reviewUnavailable: String = "The review activity is unavailable.",
    val packagePreparationRejected: String = "Package preparation was rejected.",
    val saveCancelled: String = "Save was cancelled.",
    val reviewFirst: String = "Review diagnostics first.",
    val savedBytes: String = "Saved %1\$d bytes.",
    val partialCopyBytes: String =
        "The destination retained %1\$d bytes from a partial copy.",
    val saveFailed: String = "Saving the package failed.",
    val deleteComplete: String = "All diagnostic data was deleted.",
    val deletePending: String = "Some handler-owned data remains and will be retried.",
    val deleteRejected: String = "Deletion could not start.",
    val readinessValue: String = "Readiness: %1\$s",
    val healthValue: String = "Health: %1\$s",
    val recordedCount: String = "Recorded in this process session: %1\$d",
    val readinessVolatileCapture: String = "volatile capture",
    val readinessDurable: String = "durable",
    val readinessDegraded: String = "degraded",
    val readinessClosed: String = "closed",
    val healthDisabled: String = "disabled",
    val healthInitializing: String = "initializing",
    val healthReady: String = "ready",
    val healthDegraded: String = "degraded",
    val healthDeleting: String = "deleting",
    val healthClosed: String = "closed",
    val logLevelVerbose: String = "VERBOSE",
    val logLevelDebug: String = "DEBUG",
    val logLevelInfo: String = "INFO",
    val logLevelWarn: String = "WARN",
    val logLevelError: String = "ERROR",
    val logLevelOff: String = "OFF",
    val captureJvmCrash: String = "JVM crashes",
    val captureHandledException: String = "Handled exceptions",
    val captureAnr: String = "ANR watchdog",
    val captureOsExit: String = "Android exit history",
    val captureNativeCrash: String = "Native crashes (optional module)",
    val captureRustPanic: String = "Rust panics (optional module)",
    val durationAny: String = "Any duration",
    val durationNanos: String = "%1\$d ns",
    val durationMillis: String = "%1\$d ms",
)
